...
function makeTitleOfApp()
{
    ...
    theTitle.href = 'https://github.com/ChristopherAndrewTopalian/CATopalian_JavaScript_Truth_Detection';
    theTitle.target = '_blank';
    theTitle.textContent = 'CATopalian JavaScript Truth Detection';
